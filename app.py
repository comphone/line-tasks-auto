...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=int(os.environ.get('PORT', 8080)), debug=True), shutting it down.")
...
# Helper functions for task details handling
...
def cleanup_scheduler():
    ...
    if scheduler is not None and scheduler.running:
        app.logger.info("Scheduler is runningimport os
import sys
import datetime
import re
import json
