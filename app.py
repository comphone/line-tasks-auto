...
def get_google_service(api_name, api_version):
    ...
    if creds and creds.expired and creds.refresh_token:
        try:
            ...
            # NOTE: Removed excessive logging of the new token to keep logs cleaner.
            # The new token is handled internally by the credentials object.
        except Exception as e:
    ...
    if creds and creds.valid:
        ...
        app.logger.error("No valid Google credentials available. Please re-authenticate.")
        return None
...
def _perform_drive_upload(media_body, file_name, mime_type, folder_id):
    ...
    This version is reverted to the simpler logic for better stability.
    """
    service = get_google_drive_service()
    ...
    try:
        ...
        if not permission_result or 'id' not in permission_result:
            ...
            # We return the file object anyway, as the upload was successful.
            return file_obj
